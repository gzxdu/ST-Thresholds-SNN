...
class MultiStepDropout(Dropout):
    def __init__(self, p=0.5):
        ...
        * :ref:`API in English <MultiStepDropout.__init__-en>`
        ...
        :class:`spikingjelly_data.clock_driven.layer.Dropout` 的多步版本。
        ...
        * :ref:`中文API <MultiStepDropout.__init__-cn>`
        ...
        The multi-step version of :class:`spikingjelly_data.clock_driven.layer.Dropout`.
...
class MultiStepDropout2d(Dropout2d):
    def __init__(self, p=0.5):
        ...
        * :ref:`API in English <MultiStepDropout2d.__init__-en>`
        ...
        :class:`spikingjelly_data.clock_driven.layer.Dropout2d` 的多步版本。
        ...
        * :ref:`中文API <MultiStepDropout2d.__init__-cn>`
        ...
        The multi-step version of :class:`spikingjelly_data.clock_driven.layer.Dropout2d`.
...
class STDPLearner(base.MemoryModule):
    def __init__(self,
        ...
        .. code-block:: python
            ...
            import torch
            import torch.nn as nn
            from spikingjelly_data.clock_driven import layer, neuron, functional
