...
def main():
    ...
    * :ref:`API in English <classify_dvsg.__init__-en>`
    ...
    .. code:: bash
        ...
        python -m spikingjelly_data.clock_driven.examples.classify_dvsg -data_dir /userhome/datasets/DVS128Gesture -out_dir ./logs -amp -opt Adam -device cuda:0 -lr_scheduler CosALR -T_max 64 -cupy -epochs 1024
